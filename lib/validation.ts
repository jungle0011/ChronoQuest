...
export const BusinessFormSchema = z.object({
  ...
  businessDescription: z.string().min(5, 'Description must be at least 5 characters').max(1000).transform(val => DOMPurify.sanitize(val)),
  ...
  ownerPictureUrl: z.string().url('Invalid picture URL').optional().or(z.literal('')),
  siteStyle: z.enum(['modern', 'elegant', 'bold', 'minimal', 'creative', 'corporate', 'luxury', 'neon', 'vintage', 'glassmorphism', 'nature']),
  colorScheme: z.enum(['blue', 'purple', 'green', 'orange', 'red', 'dark', 'gradient', 'gold', 'teal', 'rose', 'slate', 'rainbow']),
